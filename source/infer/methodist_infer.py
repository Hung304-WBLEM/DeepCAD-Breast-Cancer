...
if __name__ == '__main__':
    ...
    methodist_data = os.path.join(
        data_root, proj_paths_json['DATA']['methodist_data'])
    ...
    config_file = os.path.join(
        mmdet_root, 'configs', 'ddsm', 'mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_ddsm.py')

    model_root = os.path.join(
        experiment_root, saved_models_root, 'mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_ddsm')
    ...
    save_root = os.path.join(experiment_root, models_root,
                             'mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_ddsm')
