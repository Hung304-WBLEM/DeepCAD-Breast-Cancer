...
python plot_eval_curve.py -gt ${mass_test_gt} -p ${mass_detection_root}/faster_rcnn_r50_caffe_fpn_mstrain_1x_ddsm/result.bbox.json -bb all -s ${mass_detection_root}/faster_rcnn_r50_caffe_fpn_mstrain_1x_ddsm/
