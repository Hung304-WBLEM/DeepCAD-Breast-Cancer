...
do
    python run.py \
           --exp_name pathology_4class_original_mae_plotting_curve_224 \
           -d four_classes_mass_calc_pathology \
           --train_rate $i \
           --one_stage_training \
           --njobs 10 \
           -m 'mae_vit_base_patch16'\
           --ckpt '/home/hqvo2/Projects/Breast_Cancer/libs/mae/jobdir/vit_base_patch16_input224_b64_combined_datasets/checkpoint-499.pth' \
           -b 32 \
