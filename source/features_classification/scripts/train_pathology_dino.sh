...
python run.py \
       ...
       --one_stage_training \
       --njobs 10 \
       -m 'dino_vit_base_patch16'\
       --ckpt '/home/hqvo2/Projects/Breast_Cancer/libs/dino/experiments/vit_base_outdim2048_imgsize112_combined_datasets/checkpoint0500.pth'\
       -b 32 \
