...
python run.py \
       ...
       --ckpt '/home/hqvo2/Projects/Breast_Cancer/libs/SimMIM/outdir/simmim_pretrain/simmim_pretrain__swin_base__maskpatch32_075__img192_window6__500ep/ckpt_epoch_499.pth' \
       -b 32 \
